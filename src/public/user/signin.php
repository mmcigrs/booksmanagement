  ...
  <div class="w-96  bg-white pt-10 pb-10 rounded-xl">
    <div class="w-60 m-auto text-center">
      ...
      <form class="px-4" action="./signin_complete.php" method="POST">
        <p><input class="border-2 border-gray-300 mb-5 w-full" type=“text” name="email" type="email" placeholder="Email"
            value="<?php echo $email; ?>"></p>
        <p><input class="border-2 border-gray-300 mb-5 w-full" type="password" placeholder="Password" name="password">
        </p>
        <button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-1 px-2 rounded mb-5 w-full"
